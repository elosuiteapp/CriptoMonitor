...
export const GLOSSARY: Record<string, string> = {
  ...
  bookImbalance: "Pressão do book: soma das ordens LIMITE paradas perto do preço (bid = compra, ask = venda), nas faixas ±0,5% e ±2%. Mais bid = book comprador (suporte); mais ask = vendedor (resistência). Separado por audiência: varejo (Binance) × institucional (Coinbase) — igual ao prêmio Coinbase. Diferente do CVD (negócio já executado): aqui é liquidez esperando, e pode ser puxada (spoof). A leitura forte é cruzar com o CVD: book comprador + CVD subindo = pressão real; em direções opostas, desconfie.",
