...
/** Notícias do mercado de câmbio (Forex) — isolado. Lê news_feed com market='forex'
 *  (não toca cripto/B3). Fontes globais de FX/macro (ActionForex, BabyPips, Investing). */
export default function ForexNewsBlock() {
