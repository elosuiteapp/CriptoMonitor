...
/** Subgráfico de RSI (14) — sobrecompra (>70) / sobrevenda (<30). SVG leve, padrão do cripto. */
...
/** Subgráficos de momento (RSI/MACD) abaixo do gráfico de preço do cockpit B3. */
export default function B3IndicatorPanels({ candles, showRsi, showMacd }: { candles: B3Candle[]; showRsi: boolean; showMacd: boolean }) {
