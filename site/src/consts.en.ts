...
export const PRICING_EN = {
  plans: [
    {
      tagline: "All 3 markets, live",
      features: [
        "LIVE data, no delay",
        "Crypto: real-time BTC cockpit + layers (gamma, VP, retail CVD)",
        "Basics of every market: Crypto, B3, and Forex",
    ...
    },
    {
      ...
      features: [
        "All 3 markets complete, no limits",
        "20 crypto assets + gamma, options, and full flow",
        "Smart Money & On-chain (SMC) across all 3 markets",
        "Market Read: bias, conviction, and targets",
        "30 AI analyses per day + reports and alerts",
      ],
      cta: "Go Pro",
      usd: 29,
      usdAnnual: 24,
...
export const COMPARISON_EN = [
  {
    group: "Markets",
    rows: [
      { label: "Markets included", free: "Basics of all 3, live", pro: "Crypto + B3 + Forex, complete" },
      { label: "Full cockpit, no gates", free: "BTC (showcase)", pro: true },
      { label: "Data refresh", free: "Real time, no delay", pro: "Real time, no delay" },
    ],
  },
  {
    group: "What Pro unlocks",
    rows: [
      { label: "Gamma, options, and institutional levels", free: "BTC only", pro: true },
      { label: "Flow: funding, CVD, long/short, and liquidations", free: false, pro: true },
      { label: "Smart Money: structure, order blocks, liquidity, and FVG", free: false, pro: true },
      { label: "Institutional vs. retail (smart money vs. leveraged)", free: false, pro: true },
      { label: "Market Read: bias, conviction, and targets", free: false, pro: true },
      { label: "Advanced chart layers (CVD, order book, heatmap)", free: "BTC only", pro: true },
    ],
  },
  {
    group: "Macro, AI, and alerts",
    rows: [
      { label: "Macro & Correlations", free: "Preview", pro: "Full" },
      { label: "Economic calendar and news", free: true, pro: true },
      { label: "AI reports and analyses", free: "1 per day", pro: "30 per day" },
      { label: "In-app, push, and email alerts", free: false, pro: true },
      { label: "Full weekly newsletter", free: true, pro: true },
    ],
  },
];
