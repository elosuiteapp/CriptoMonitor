-- 076 — Consenso mínimo de timeframes configurável (voto N-de-M). Padrão 3 (dono quer 3-de-4
-- com o TF de 4h somado). Adicionar 4H aos timeframes é no código do bot-run.
alter table public.bot_config add column if not exists min_votes int not null default 3;
