...
values
  ...
  ('pro',    'Pro',     5900, 1, array['BTC','ETH','SOL','BNB'],   5, true,  true,    10, 'claude-sonnet-4-6', array['email'],            30),
  ('expert', 'Expert', 14900, 2, array['BTC','ETH','SOL','BNB'],   5, true,  true,  null, 'claude-fable-5',    array['email','whatsapp'], null)
